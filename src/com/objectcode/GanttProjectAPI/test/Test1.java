...
// Task-data:  
    ...
    log("Task with Id=4: " + ganttDiagram.getTaskById("4").toString() );           	//way 1
    log("Task wiht ID=5: " + ganttDiagram.getActivitiesAndMilestones().get("5"));	//way 2 be shure the Id is an Activity or a Milestone and not an Phase otherwise use way 1
