...
public class GanttProjectAPIJUnitReadTest {
    ...
    String ganttDiagramFile = "/home/objectcode/workspace/GanttProjectAPI/data/Demo1.gan"; 		//Use this ore an equal path for Unix-systems
...
//		assertEquals("resource id", "2", ganttDiagram.getResourceId("CLI")); //fehler gleicher name unterschiedliche ids
...
//		assertEquals("resource id", "3", ganttDiagram.getResourceId("CLI")); //fehler gleicher name unterschiedliche ids
...
//		assertEquals("allocation task-id","[1, 2]", ganttDiagram.getResourceAllocationTaskIds("0").toString()); 	//TODO: Fehler aufgrund Zahlendreher [1,2] [2,1]
//		assertEquals("allocation task-id","[4, 5]", ganttDiagram.getResourceAllocationTaskIds("1").toString()); 	//TODO:Fehler aufgrund Zahlendreher [5,4] [4,5]
